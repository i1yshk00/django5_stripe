...
- Обязательно ли выполнять доп.задания?  
- Доп. задания играют роль как отличающий фактор, среди тех, кто выполнит тестовое

- Что будет в случае успешного выполнения тестового задания?  
...
- Нужно ли разворачивать сервер?  
- В идеальном сценарии, ваше решение развернуто на сервере и вы пришлете нам ссылку на развернутое решение в интернете с доступами.

- Можно ли использовать библиотеки, не указанные в задании?  
- Можно использовать любые другие библиотеки, которые явно не указаны в задании. Но при этом обязательно необходимо использовать Djangо и Stripe, как основу сервиса.

- Какие критерии оценивания задания?  
- Корректность реализации сервиса, качество написанного кода, публикация на сервере с предоставлением доступа, выполнение дополнительных пунктов.

- Работаете ли с гражданами не из РФ?  
- Да, работаем